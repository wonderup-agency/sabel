...
function home () {
  ...
  if (infinityPath && heroSection) {
    ...
    // Offset line2 so they start at different positions on the path
    gsap.set(line1, { strokeDashoffset: 0 });
    gsap.set(line2, { strokeDashoffset: -(pathLength * 0.5) });
    ...
    loopTl.to(line2, {
      strokeDashoffset: -(pathLength * 0.5 + pathLength),
      duration: 6,
      ease: 'none',
    }, 0);
...
//# sourceMappingURL=home-C7y225Rf.js.map
