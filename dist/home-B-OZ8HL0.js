...
function home () {
  ...
  if (infinityPath && heroSection) {
    ...
    // Vertical starts drawing FROM the dot — simultaneous
    convergeTl.to(verticalPath, { opacity: 1, duration: 0.05 }, 1.0);
    convergeTl.to(verticalPath, {
      strokeDashoffset: 0,
      duration: 0.8, ease: 'power2.out',
    }, 1.0);

    // Dot shrinks as vertical grows through it
...
//# sourceMappingURL=home-B-OZ8HL0.js.map
