...
function home () {
  ...
  if (infinityPath && heroSection) {
    ...
    // 3. Dot fades, vertical draws
    convergeTl.to(verticalPath, { opacity: 1, duration: 0.1 }, 1.2);
    convergeTl.to(centerDot, {
      scale: 0,
      opacity: 0,
      duration: 0.4,
    ...
    // When convergence fully reverses, restart the loop
    ...
    ScrollTrigger.create({
      ...
      pin: true,
      onUpdate(self) {
        // Scroll DOWN past threshold: kill loop, play convergence forward
      ...
      onEnterBack() {
        // Coming back from below — clean up global lines, reverse convergence
...
//# sourceMappingURL=home-D71flfxq.js.map
