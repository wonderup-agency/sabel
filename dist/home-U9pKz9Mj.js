...
function home () {
    ...
    starts.forEach((startEl) => {
      ...
      gsap.to(line, {
        ...
        scrollTrigger: {
          ...
          onUpdate(self) {
            if (id === '2') {
              console.log(`[global-line 2] progress: ${self.progress.toFixed(2)}`);
            }
          },
          onComplete: id === '2' ? () => {
            console.log('[global-line 2] COMPLETE — triggering branch lines');
            initBranchLines();
          } : undefined,
        },
      });
  ...
  function initBranchLines() {
    ...
    console.log('[branch-lines] section found:', !!section);
    if (!section) return
...
//# sourceMappingURL=home-U9pKz9Mj.js.map
