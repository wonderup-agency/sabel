...
function map (elements) {
  ...
  elements.forEach((el) => {
    ...
    defs.innerHTML = `
      ...
      <filter id="point-glow-hover" x="-400%" y="-400%" width="900%" height="900%">
    ...
    // Hover interactions
    const allHitAreas = pointsGroup.querySelectorAll('circle[fill="transparent"]');
    const allDots = svg.querySelectorAll('.map-point');

    allHitAreas.forEach((hit) => {
      hit.addEventListener('mouseenter', () => {
        const hovered = hit._dot;
        // Scale up hovered point with stronger glow
        gsap.to(hovered, {
          attr: { r: 12 },
          opacity: 1,
          duration: 0.3,
        ...
        hovered.setAttribute('filter', 'url(#point-glow-hover)');
        // Shrink all others
        allDots.forEach((dot) => {
      ...
      hit.addEventListener('mouseleave', () => {
        hit._dot.removeAttribute('filter');
        // Restore all points
        allDots.forEach((dot) => {
          gsap.to(dot, {
            attr: { r: 5 },
...
//# sourceMappingURL=map-Dlab2Wzs.js.map
