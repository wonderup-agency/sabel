...
const DENSITY = 1.0;
const OPACITY = 0.15;
console.log('Initializing noise-effect component with settings:');
function createNoiseCanvas(width, height) {
  const canvas = document.createElement('canvas');
  canvas.width = Math.ceil(width / NOISE_SIZE);
  canvas.height = Math.ceil(height / NOISE_SIZE);
...
//# sourceMappingURL=noise-effect-BiI7TdzC.js.map
