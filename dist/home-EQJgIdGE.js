...
function home () {
  ...
  if (infinityPath && heroSection) {
    ...
    const segmentLength = pathLength * 0.35;

    // Snake effect: a visible segment travels along the path
...
//# sourceMappingURL=home-EQJgIdGE.js.map
